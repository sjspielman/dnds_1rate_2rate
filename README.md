#### Repository for ["A comparison of one-rate and two-rate inference frameworks for site-specific *dN/dS* estimation"](http://www.genetics.org/content/204/2/499) by SJS\*, SW, COW.
