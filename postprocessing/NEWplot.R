...
dnds.sum.mean <- dnds.sum %>% filter(method %in% method_order) %>% group_by(method, ntaxa, bl, biastype, pitype) %>% na.omit() %>% filter(!is.infinite(rmsd), !is.infinite(resvar)) %>% summarize(r = mean(r), estbias = mean(estbias), rmsd = mean(rmsd), resvar = mean(resvar))
dn.ds.sum.mean <- dn.ds.sum %>% filter(method %in% method_order) %>% group_by(method, ntaxa, bl, biastype, pitype) %>% na.omit() %>% filter(!is.infinite(rmsd), !is.infinite(resvar)) %>% summarize(r = mean(r), estbias = mean(estbias), rmsd = mean(rmsd))
...
realdat %>% filter(method %in% c("FUBAR2"), biastype == "bias") %>% summarize_dn_real() -> dn
realdat %>% filter(method %in% c("FUBAR2"), biastype == "bias") %>% summarize_ds_real() -> ds
...
r.nobias.unequalpi <- dnds.sum.mean %>% filter(pitype == "unequalpi", biastype == "nobias") %>% ggplot(aes(x = factor(ntaxa), y = r, group = method, color=method)) +  geom_line(size=0.75, alpha=0.7) + geom_point(size=2, alpha=0.7) + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-0.1, 1), breaks = c(-0.1,0.1, 0.3, 0.5, 0.7, 0.9)) + xlab("Number of Taxa") + ylab("Correlation") + scale_color_manual(values = method_colors, name = "Inference Method") + background_grid("xy") + ggtitle("No codon bias") + theme(axis.text.x = element_text(size = 9, angle=30))
r.bias.unequalpi <- dnds.sum.mean %>% filter(pitype == "unequalpi", biastype == "bias") %>% ggplot(aes(x = factor(ntaxa), y = r, group = method, color=method)) +  geom_line(size=0.75, alpha=0.7) + geom_point(size=2, alpha=0.7) + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-0.1, 1), breaks = c(-0.1, 0.1, 0.3, 0.5, 0.7, 0.9)) + xlab("Number of Taxa") + ylab("Correlation") + scale_color_manual(values = method_colors, name = "Inference Method") + background_grid("xy") + ggtitle("Codon bias") + theme(axis.text.x = element_text(size = 9, angle=30))
...
# param.r.fubar2.equal <- dn.ds.sum %>% filter(pitype == "equalpi", biastype == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = r, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-0.1, 1), breaks = c(-0.1, 0.1, 0.3, 0.5, 0.7, 0.9)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("Correlation") + scale_fill_manual(values = dn_ds_colors) + theme(legend.position = "none")
# param.r.fubar2.unequal <- dn.ds.sum %>% filter(pitype == "unequalpi", biastype == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = r, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-0.1, 1), breaks = c(-0.1, 0.1, 0.3, 0.5, 0.7, 0.9)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("Correlation") + scale_fill_manual(values = dn_ds_colors) + theme(legend.position = "none")
# param.estbias.fubar2.equal <- dn.ds.sum %>% filter(pitype == "equalpi", biastype == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = estbias, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,2)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("Estimator Bias") + scale_fill_manual(values = dn_ds_colors)  + theme(legend.position = "none")
# #param.estbias.fubar2.unequal <- dn.ds.sum %>% filter(pitype == "unequalpi", biastype == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = estbias, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,2)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("Estimator Bias") + scale_fill_manual(values = dn_ds_colors) + theme(legend.position = "none")
# param.rmsd.fubar2.equal <- dn.ds.sum %>% filter(pitype == "equalpi", biastype == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = rmsd, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,5)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("RMSD") + scale_fill_manual(values = dn_ds_colors)  + theme(legend.position = "none")
# param.rmsd.fubar2.unequal <- dn.ds.sum %>% filter(pitype == "unequalpi", biastype == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = rmsd, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,5)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("RMSD") + scale_fill_manual(values = dn_ds_colors) + theme(legend.position = "none")
#
#
#
...
param.r.fel2.equal <- dn.ds.sum %>% filter(pitype == "equalpi", biastype == "bias", method == "FEL2", bl>=0.01) %>% ggplot(aes(x = factor(ntaxa), y = r, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-0.1, 1), breaks = c(-0.1, 0.1, 0.3, 0.5, 0.7, 0.9)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("Correlation") + scale_fill_manual(values = dn_ds_colors)  + theme(axis.text.x = element_text(size = 8, angle=30), legend.position = "none")
param.r.fel2.unequal <- dn.ds.sum %>% filter(pitype == "unequalpi", biastype == "bias", method == "FEL2", bl>=0.01) %>% ggplot(aes(x = factor(ntaxa), y = r, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-0.1, 1), breaks = c(-0.1, 0.1, 0.3, 0.5, 0.7, 0.9)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("Correlation") + scale_fill_manual(values = dn_ds_colors)  + theme(axis.text.x = element_text(size = 8, angle=30), legend.position = "none")
#param.estbias.fel2.equal <- dn.ds.sum %>% filter(pitype == "equalpi", biastype == "bias", method == "FEL2", bl>=0.01) %>% ggplot(aes(x = factor(ntaxa), y = estbias, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,2)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("Estimator Bias") + scale_fill_manual(values = dn_ds_colors)  + theme(legend.position = "none")
#param.estbias.fel2.unequal <- dn.ds.sum %>% filter(pitype == "unequalpi", biastype == "bias", method == "FEL2", bl>=0.01) %>% ggplot(aes(x = factor(ntaxa), y = estbias, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,2)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("Estimator Bias") + scale_fill_manual(values = dn_ds_colors) + theme(legend.position = "none")
param.rmsd.fel2.equal <- dn.ds.sum %>% filter(pitype == "equalpi", biastype == "bias", method == "FEL2", bl>=0.01) %>% ggplot(aes(x = factor(ntaxa), y = rmsd, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,5)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("RMSD") + scale_fill_manual(values = dn_ds_colors)  + theme(axis.text.x = element_text(size = 8, angle=30), legend.position = "none")
param.rmsd.fel2.unequal <- dn.ds.sum %>% filter(pitype == "unequalpi", biastype == "bias", method == "FEL2", bl>=0.01) %>% ggplot(aes(x = factor(ntaxa), y = rmsd, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,5)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("RMSD") + scale_fill_manual(values = dn_ds_colors)  + theme(axis.text.x = element_text(size = 8, angle=30), legend.position = "none")
...
ntaxa.bl.r <- treelen.dat %>% filter(pitype == "unequalpi") %>% ggplot(aes(x = as.factor(bl), y = r, fill = as.factor(type))) + geom_boxplot(position = position_dodge(0.75), lwd=0.3, outlier.size=0.8) + xlab("Parameterization") + scale_x_discrete(labels = c("N = 2048\nB = 0.04","N = 512\nB = 0.16","N = 128\nB = 0.64")) + ylab("Correlation") + scale_y_continuous(limits=c(0.45, 0.95)) + scale_fill_manual(values = c("grey40", "grey80")) + theme(legend.position = "none")
ntaxa.bl.rmsd <- treelen.dat %>% filter(pitype == "unequalpi") %>% ggplot(aes(x = as.factor(bl), y = rmsd, fill = as.factor(type))) + geom_boxplot(position = position_dodge(0.75), lwd=0.3, outlier.size=0.8) + xlab("Parameterization") + scale_x_discrete(labels = c("N = 2048\nB = 0.04","N = 512\nB = 0.16","N = 128\nB = 0.64")) + ylab("RMSD") + scale_y_continuous(limits=c(0,0.75)) + scale_fill_manual(values = c("grey40", "grey80")) + theme(legend.position = "none")
...
ntaxa.bl.r <- treelen.dat %>% filter(pitype == "equalpi") %>% ggplot(aes(x = as.factor(bl), y = r, fill = as.factor(type))) + geom_boxplot(position = position_dodge(0.75), lwd=0.3, outlier.size=0.8) + xlab("Parameterization") + scale_x_discrete(labels = c("N = 2048\nB = 0.04","N = 512\nB = 0.16","N = 128\nB = 0.64")) + ylab("Correlation") + scale_y_continuous(limits=c(0.45, 0.95)) + scale_fill_manual(values = c("grey40", "grey80")) + theme(legend.position = "none")
ntaxa.bl.rmsd <- treelen.dat %>% filter(pitype == "equalpi") %>% ggplot(aes(x = as.factor(bl), y = rmsd, fill = as.factor(type))) + geom_boxplot(position = position_dodge(0.75), lwd=0.3, outlier.size=0.8) + xlab("Parameterization") + scale_x_discrete(labels = c("N = 2048\nB = 0.04","N = 512\nB = 0.16","N = 128\nB = 0.64")) + ylab("RMSD") + scale_y_continuous(limits=c(0,0.75)) + scale_fill_manual(values = c("grey40", "grey80")) + theme(legend.position = "none")
ntaxa.bl.r.rmsd <- plot_grid(ntaxa.bl.r, ntaxa.bl.rmsd, nrow=1, labels=c("A", "B"))
ntaxa.bl.r.rmsd.legend <- plot_grid(ntaxa.bl.r.rmsd, legend, nrow=2, rel_heights=c(1,0.1))
