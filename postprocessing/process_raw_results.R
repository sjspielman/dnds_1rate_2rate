    ...
    for (n in ntaxa){
        ...
        for (bl in branch_lengths){
            ...
            for (repl in 1:nreps){
                ...
                firstpart   <- data.frame("ntaxa" = rep(2^n, numcol), "bl" = rep(bl, numcol), "site" = 1:numcol, "rep" = repl, "true1" = true_dnds1, "true2" = true_dnds2, "truedn" = true_dn, "trueds" = true_ds, "type" = rep(type, numcol) )    
