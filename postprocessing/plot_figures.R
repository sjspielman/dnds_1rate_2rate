...
## Estimator Bias
estbias.nobias.equalpi <- dnds.sum.mean %>% filter(pi == "equal", type == "nobias") %>% ggplot(aes(x = factor(ntaxa), y = estbias, group = method, color = method)) + geom_line(size=0.75, alpha=0.7) + geom_point(size=2, alpha=0.7) + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-1,1.3)) + xlab("Number of Taxa") + ylab("RMSD") + scale_color_manual(values = method_colors, name = "Inference Method") + background_grid("xy") + ggtitle("No codon bias")
estbias.bias.equalpi <- dnds.sum.mean %>% filter(pi == "equal", type == "bias") %>% ggplot(aes(x = factor(ntaxa), y = estbias, group = method, color = method)) + geom_line(size=0.75, alpha=0.7) + geom_point(size=2, alpha=0.7) + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-1,1.3)) + xlab("Number of Taxa") + ylab("RMSD") + scale_color_manual(values = method_colors, name = "Inference Method") + background_grid("xy") + ggtitle("Codon bias")
estbias.equalpi <- plot_grid(estbias.nobias.equalpi, estbias.bias.equalpi, nrow=2, labels=c("A", "B"))
save_plot(paste0(PLOTDIR, "estbias_lineplots_equalpi.pdf"), estbias.equalpi, base_width = 9, base_height=5)


estbias.nobias.unequalpi <- dnds.sum.mean %>% filter(pi == "unequal", type == "nobias") %>% ggplot(aes(x = factor(ntaxa), y = estbias, group = method, color = method)) + geom_line(size=0.75, alpha=0.7) + geom_point(size=2, alpha=0.7) + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-1, 2)) + xlab("Number of Taxa") + ylab("RMSD") + scale_color_manual(values = method_colors, name = "Inference Method") + background_grid("xy") + ggtitle("No codon bias")
estbias.bias.unequalpi <- dnds.sum.mean %>% filter(pi == "unequal", type == "bias") %>% ggplot(aes(x = factor(ntaxa), y = estbias, group = method, color = method)) + geom_line(size=0.75, alpha=0.7) + geom_point(size=2, alpha=0.7) + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-1, 2)) + xlab("Number of Taxa") + ylab("RMSD") + scale_color_manual(values = method_colors, name = "Inference Method") + background_grid("xy") + ggtitle("Codon bias")
estbias.unequalpi <- plot_grid(estbias.nobias.unequalpi, estbias.bias.unequalpi, nrow=2, labels=c("A", "B"))
save_plot(paste0(PLOTDIR, "estbias_lineplots_unequalpi.pdf"), estbias.unequalpi, base_width = 9, base_height=5)
...
rmsd.equalpi <- plot_grid(rmsd.nobias.equalpi, rmsd.bias.equalpi, nrow=2, labels=c("A", "B"))
save_plot(paste0(PLOTDIR, "rmsd_lineplots_equalpi.pdf"), rmsd.equalpi, base_width = 9, base_height=5)
...
rmsd.unequalpi <- plot_grid(rmsd.nobias.unequalpi, rmsd.bias.unequalpi, nrow=2, labels=c("A", "B"))
save_plot(paste0(PLOTDIR, "rmsd_lineplots_unequalpi.pdf"), rmsd.unequalpi, base_width = 9, base_height=5)
...
resvar.equalpi <- plot_grid(resvar.nobias.equalpi, resvar.bias.equalpi, nrow=2, labels=c("A", "B"))
save_plot(paste0(PLOTDIR, "resvar_lineplots_equalpi.pdf"), resvar.equalpi, base_width = 9, base_height=5)
...
resvar.unequalpi <- plot_grid(resvar.nobias.unequalpi, resvar.bias.unequalpi, nrow=2, labels=c("A", "B"))
save_plot(paste0(PLOTDIR, "resvar_lineplots_unequalpi.pdf"), resvar.unequalpi, base_width = 9, base_height=5)
...
dn.ds.fel2.sub.legend <- plot_grid(param.r.fel2.sub , param.estbias.fel2.sub, param.rmsd.fel2.sub, dn.ds.legend, nrow=4, labels = c("A", "B", "C"), rel_heights=c(1,1,1,0.1))
save_plot(paste0(PLOTDIR, "dn_ds_unequal_violin_fel2_subset.pdf"), dn.ds.fel2.sub.legend, base_width = 6.5, base_height=6)
...
param.r.fubar2.equal <- dn.ds.sum %>% filter(pi == "equal", type == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = r, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-0.1, 1), breaks = c(-0.1, 0.1, 0.3, 0.5, 0.7, 0.9)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("Correlation") + scale_fill_manual(values = dn_ds_colors) + ggtitle("Equal F") + theme(legend.position = "none")
param.r.fubar2.unequal <- dn.ds.sum %>% filter(pi == "unequal", type == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = r, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + scale_y_continuous(limits=c(-0.1, 1), breaks = c(-0.1, 0.1, 0.3, 0.5, 0.7, 0.9)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("Correlation") + scale_fill_manual(values = dn_ds_colors) + ggtitle("Unequal F") + theme(legend.position = "none")
param.rmsd.fubar2.equal <- dn.ds.sum %>% filter(pi == "equal", type == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = rmsd, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,5)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("RMSD") + scale_fill_manual(values = dn_ds_colors) + ggtitle("Equal F") + theme(legend.position = "none")
param.rmsd.fubar2.unequal <- dn.ds.sum %>% filter(pi == "unequal", type == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = rmsd, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,5)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("RMSD") + scale_fill_manual(values = dn_ds_colors) + ggtitle("Unequal F") + theme(legend.position = "none")
param.estbias.fubar2.equal <- dn.ds.sum %>% filter(pi == "equal", type == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = rmsd, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,5)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("RMSD") + scale_fill_manual(values = dn_ds_colors) + ggtitle("Equal F") + theme(legend.position = "none")
param.estbias.fubar2.unequal <- dn.ds.sum %>% filter(pi == "unequal", type == "bias", method == "FUBAR2") %>% ggplot(aes(x = factor(ntaxa), y = rmsd, fill = parameter)) + geom_violin(scale = "width") + facet_grid(~bl, scales = "free_x") + coord_cartesian(ylim=c(0,5)) + background_grid(major = "xy") + xlab("Number of Taxa") + ylab("RMSD") + scale_fill_manual(values = dn_ds_colors) + ggtitle("Unequal F") + theme(legend.position = "none")



param.r.fubar2 <- plot_grid(param.r.fubar2.equal, param.r.fubar2.unequal, nrow=1, labels=c("A", "B"))
param.rmsd.fubar2 <- plot_grid(param.rmsd.fubar2.equal, param.rmsd.fubar2.unequal, nrow=1, labels=c("C", "D"))
...
param.r.fel2 <- plot_grid(param.r.fel2.equal, param.r.fel2.unequal, nrow=1, labels=c("A", "B"))
param.rmsd.fel2 <- plot_grid(param.rmsd.fel2.equal, param.rmsd.fel2.unequal, nrow=1, labels=c("C", "D"))
...
linmodels %>% filter(model == "resvar", pi == "unequal") %>% arrange(comp) %>%
    ggplot(aes(x = coeff, y = comp, color = sig)) + geom_point(size=ptsize) + 
    geom_segment(aes(x=lowerCI,xend=upperCI,y=comp,yend=comp),size=linesize) + 
    geom_vline(xintercept=0, size=0.5) + 
    facet_grid(~type) + background_grid() +
    xlab("Average Residual Variance Difference") + ylab("Comparison") + 
    scale_x_continuous(limits=c(-0.3,0.25)) +  
    scale_color_manual(values = sig_colors) -> linmodel.unequal.resvar

linmodel.unequal <- plot_grid(linmodel.unequal.r, linmodel.unequal.rmsd, linmodel.unequal.resvar, nrow=3, labels=c("A", "B", "C"), scale=0.95)
save_plot(paste0(PLOTDIR, "linmodels_unequal.pdf"), linmodel.unequal, base_width = 6.5, base_height = 8)
...
linmodels %>% filter(model == "resvar", pi == "equal") %>% arrange(comp) %>%
    ggplot(aes(x = coeff, y = comp, color = sig)) + geom_point(size=ptsize) + 
    geom_segment(aes(x=lowerCI,xend=upperCI,y=comp,yend=comp),size=linesize) + 
    geom_vline(xintercept=0, size=0.5) + 
    facet_grid(~type) + background_grid() +
    xlab("Average Residual Variance Difference") + ylab("Comparison") + 
    scale_x_continuous(limits=c(-0.6,0.25)) +  
    scale_color_manual(values = sig_colors) -> linmodel.equal.resvar

linmodel.equal <- plot_grid(linmodel.equal.r, linmodel.equal.rmsd, linmodel.equal.resvar, nrow=3, labels=c("A", "B", "C"), scale=0.95)
save_plot(paste0(PLOTDIR, "linmodels_equal.pdf"), linmodel.equal, base_width = 6.5, base_height = 8)
...
save_plot(paste0(PLOTDIR, "counted_ratio_unequal_bias.pdf"), count.ratio.box, base_width = 8, base_height = 5)
...
count.ratio.box <- ggplot(ns_count_ratio, aes(x = as.factor(bl), y = mean_ratio, fill = as.factor(ntaxa))) + geom_boxplot(outlier.size = 0.75) + geom_hline(yintercept=1) + scale_fill_brewer(palette = "YlGn", name = "Number of Taxa") + xlab("Branch Length") + ylab("Mean N/S count ratio") + scale_y_continuous(limits=c(0,4))
save_plot(paste0(PLOTDIR, "counted_ratio_unequal_nobias.pdf"), count.ratio.box, base_width = 8, base_height = 5)
...
count.ratio.box <- ggplot(ns_count_ratio, aes(x = as.factor(bl), y = mean_ratio, fill = as.factor(ntaxa))) + geom_boxplot(outlier.size = 0.75) + geom_hline(yintercept=1) + scale_fill_brewer(palette = "YlGn", name = "Number of Taxa") + xlab("Branch Length") + ylab("Mean N/S count ratio") +  scale_y_continuous(limits=c(0,4))
save_plot(paste0(PLOTDIR, "counted_ratio_equal_bias.pdf"), count.ratio.box, base_width = 8, base_height = 5)
...
count.ratio.box <- ggplot(ns_count_ratio, aes(x = as.factor(bl), y = mean_ratio, fill = as.factor(ntaxa))) + geom_boxplot(outlier.size = 0.75) + geom_hline(yintercept=1) + scale_fill_brewer(palette = "YlGn", name = "Number of Taxa") + xlab("Branch Length") + ylab("Mean N/S count ratio") + scale_y_continuous(limits=c(0,4))
save_plot(paste0(PLOTDIR, "counted_ratio_equal_nobias.pdf"), count.ratio.box, base_width = 8, base_height = 5)
...
real.plots <- plot_grid(r.dnds, rmsd.dnds, resvar.dnds, nrow=3, labels=c("A", "B", "C"))
real.plots.withlegend <- plot_grid(real.plots, fubar.legend, nrow=2, rel_heights=c(1,0.08) )
save_plot(paste0(PLOTDIR, "real_r_rmsd_resvar.pdf"), real.plots.withlegend, base_width = 6, base_height = 6.25)
...
real.plots.dn.ds <- plot_grid(r.dn.ds, rmsd.dn.ds, resvar.dn.ds, nrow=3, labels=c("A", "B", "C"))
save_plot(paste0(PLOTDIR, "real_dn_ds_r_rmsd_resvar.pdf"), real.plots.dn.ds, base_width = 6, base_height = 6.5)
...
nobias.fubar.dn <- nobias.compare.dn %>% ggplot(aes(x = FUBAR1, y = FUBAR2)) + geom_point() + facet_grid(ntaxa~bl) + geom_abline(slope=1, intercept=0, color="red", size=0.7) + scale_x_continuous(limits=c(0,1), breaks=c(0, 0.5, 1)) + scale_y_continuous(limits=c(0,1), breaks=c(0, 0.5, 1)) + xlab("dN, FUBAR1") + ylab("dN, FUBAR2")
nobias.fel.dn <-nobias.compare.dn %>% ggplot(aes(x = FEL1, y = FEL2)) + geom_point() + facet_grid(ntaxa~bl) + geom_abline(slope=1, intercept=0, color="red", size=0.7) + scale_x_continuous(limits=c(0,1), breaks=c(0, 0.5, 1)) + scale_y_continuous(limits=c(0,1), breaks=c(0, 0.5, 1)) + xlab("dN, FEL1") + ylab("dN, FEL2")

bias.fubar.dn <- bias.compare.dn %>% ggplot(aes(x = FUBAR1, y = FUBAR2)) + geom_point() + facet_grid(ntaxa~bl) + geom_abline(slope=1, intercept=0, color="red", size=0.7) + scale_x_continuous(limits=c(0,1), breaks=c(0, 0.5, 1)) + scale_y_continuous(limits=c(0,1), breaks=c(0, 0.5, 1)) + xlab("dN, FEL1") + ylab("dN, FEL2")
bias.fel.dn <-bias.compare.dn %>% ggplot(aes(x = FEL1, y = FEL2)) + geom_point() + facet_grid(ntaxa~bl) + geom_abline(slope=1, intercept=0, color="red", size=0.7) +scale_x_continuous(limits=c(0,1), breaks=c(0, 0.5, 1)) + scale_y_continuous(limits=c(0,1), breaks=c(0, 0.5, 1)) + xlab("dN, FEL1") + ylab("dN, FEL2")
